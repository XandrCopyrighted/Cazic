...
(function (v) {
   ...
   return function h(p, n, m) {
      ...
      4: [function (h, p, n) {
         ...
         h = function (a) {
            function e(d) {
               ...
               var a = f(e).call(this);
               a = !a || "object" !== m(a) && "function" !== typeof a ? c(this) :
                  a;
               k(c(a), "_blob", void 0);
         ...
         h = function () {
            ...
            q(h, [{
               ...
               value: function (f, c) {
                  ...
                  if (-1 === g.startIx) this._fileData.splice(g.insertIx ||
                     0, 0, {
                        offset: f,
                        data: c
                     });
               ...
               value: function (f, c) {
                  if ("undefined" !== typeof ArrayBuffer && ArrayBuffer.isView && ArrayBuffer.isView(f)) {
                     var b =
                        new f.constructor(f.length + c.length);
                     b.set(f, 0);
                     b.set(c, f.length);
                     return b
                  }
               ...
               value: function (f, c) {
                  ...
                  for (e = k; e < this._fileData.length && !(g = this._fileData[e].offset,
                        b = g + this._fileData[e].data.length, c >= g - 1 && (r = e), c <= b + 1); e++); - 1 === r && (r = k);
                  return {
                     startIx: k,
                     endIx: r
                  }
         ...
         h = function (d) {
            ...
            t(l, [{
               ...
               value: function (d,
                  ...
                  } else -1 !== a.indexOf(c) ? (g = e + 4, d.loadRange([g, g + k], {
                     onSuccess: function () {
                        l._pictureOffset = g;
                        l._nextBlock(d, e, c, k, b)
                     }
               ...
               value: function (a, d) {
                  ...
                  this._pictureOffset && (r = a.getLongAt(this._pictureOffset, !0), d = this._pictureOffset + 4, b = a.getLongAt(d, !0), f = d + 4, d = a.getStringAt(f, b), b = f + b, f = a.getLongAt(b, !0), w = b + 4, b = a.getStringWithCharsetAt(w, f, "utf-8").toString(), f = w + f + 16, w = a.getLongAt(f, !0), a = a.getBytesAt(f + 4, w, !0), r = {
                     format: d,
                     type: e[r],
                     description: b,
                     data: a
      ...
      8: [function (h, p, n) {
         ...
         function f(a, e, d, b) {
            var l = d.getStringWithCharsetAt(a +
               1, e - 1, b);
            ...
            q(a, null, [{
               ...
               value: function (e, d, b, c, g) {
                  for (var l = {}, k = this._getFrameHeaderSize(c); e < d - k;) {
                     ...
                     if (!g || -1 !== g.indexOf(u)) {
                        ...
                        h && h.format.unsynchronisation && !c.flags.unsynchronisation && (m = this.getUnsyncFileReader(m,
                           r, w), r = 0, w = m.getSize());
               ...
               value: function (a, d) {
                  return {
                     ...
                     format: {
                        grouping_identity: a.isBitSetAt(d +
                           1, 7),
         ...
         var k = {
            ...
            CTOC: function (a, b, d, l, g) {
               ...
               for (k = 0; k < e.entryCount; k++) {
                  var f = c.readNullTerminatedString(d.getBytesAt(a,
                     b - (a - l)));
            ...
            t(a, [{
               ...
               value: function (a, b) {
                  for (var d = 0, e; e = b[d]; d++)
                     if (e in a) return a = a[e] instanceof Array ? a[e][0] : a[e], a.data
               }
            }, {
               key: "getShortcuts",
               value: function () {
            ...
            t(b, [{
               ...
               value: function (a, b, e, c, g, k, f) {
                  ...
                  for (var d = e; d < e + c;) {
                     ...
                     "moov.udta.meta.ilst" === k && this._canReadAtom(h) && (a[h] = this._readMetadataAtom(b, d));
                     d += l
                  }
               }
            }, {
      ...
      11: [function (h, p, n) {
         ...
         h = function () {
            ...
            q(c, [{
                  ...
                  key: "getBytesAt",
                  value: function (b, c) {
                     for (var g = Array(c), f = 0; f < c; f++) g[f] = this.getByteAt(b +
                        f);
                     return g
                  }
               }, {
               ...
               },
               {
                  ...
                  value: function (b) {
                     ...
                     return this.getByteAt(b +
                        3) & 127 | (h & 127) << 7 | (f & 127) << 14 | (c & 127) << 21
                  }
               }
            ], [{
               key: "canReadFile",
                  ...
                  this._mediaFileReader.init({
                     onSuccess: function () {
                        b._loadData(b._mediaFileReader, {
                           onSuccess: function () {
                              try {
                                 var g = b._parseData(b._mediaFileReader,
                                    b._tags)
                              } catch (k) {
                                 if (c.onError) {
                                    c.onError({
      ...
      13: [function (h, p, n) {
         ...
         function t(c, b, f) {
            b in c ? Object.defineProperty(c,
               b, {
                  value: f,
                  enumerable: !0,
                  configurable: !0,
         ...
         p.exports = {
            readUTF16String: function (c, b, g) {
               ...
               254 == c[0] && 255 ==
                  c[1] ? (b = !0, k = 2) : 255 == c[0] && 254 == c[1] && (b = !1, k = 2);
               b && (h = 0, a = 1);
               b = [];
               for (var e = 0; k < g; e++) {
                  var d = c[k + h],
      ...
      14: [function (h, p, n) {
         ...
         function f(a) {
            f =
               Object.setPrototypeOf ? Object.getPrototypeOf : function (a) {
                  return a.__proto__ || Object.getPrototypeOf(a)
               };
            return f(a)
         }
            ...
            t(e, [{
               ...
               value: function (a) {
                  e._config.avoidHeadRequests ?
                     this._fetchSizeWithGetRequest(a) : this._fetchSizeWithHeadRequest(a)
               }
            }, {
               ...
               value: function (a, b) {
                  var d = this;
                  d._fileData.hasDataRange(a[0],
                     Math.min(d._size, a[1])) ? setTimeout(b.onSuccess, 1) : (a = this._roundRangeToChunkMultiple(a), a[1] = Math.min(d._size, a[1]), this._makeXHRRequest("GET", a, {
               ...
               value: function (a, b, c) {
                  ...
                  "undefined" !== typeof d.onload ? (d.onload = f, d.onerror = function () {
                  ...
                  e._config.timeoutInSec && (d.timeout = 1E3 * e._config.timeoutInSec, d.ontimeout = function () {
                     if (c.onError) c.onError({
                        type: "xhr",
